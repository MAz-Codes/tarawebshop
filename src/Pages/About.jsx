    ...
    exit={{opacity:0, transition: {duration: 1} }}>
      ...
      gap={2}>
        <Stack textAlign={"left"}>
          ...
          fontSize={"md"}
          pt="10"
          >Founded in 2001 in the heart of Europe, our company was born out of a passion for sustainability and fashion. Started as a team of two eco-conscious individuals, we set out to make a difference in the fashion industry by creating sustainable and affordable clothing options.
        ...
        objectFit="cover"
        maxW={{base:"0%", md:"50%"}}
        src="https://images.unsplash.com/photo-1572577892547-18d319fcece6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=686&q=80"/>
      </HStack>
    </Box>
  )
}
